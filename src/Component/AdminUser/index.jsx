            ...
            <>
                <aside className="account-infor">
                    <div className="account-infor_name d-flex">
                        <img src={logo} alt className="img-avatar" />
                        <div className="info">
                    ...
                    <ul className="infor-item">
                        ...
                        <li>
                            <a href="#">
                                <img src="image/tiknow.png" alt />
                                <span>Thông tin MarketNow</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="image/coupon_code.svg" alt />
                                <span>Mã giảm giá</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="image/xu.png" alt />
                                <span>Quản lý Market Xu của tôi</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="image/bookcare.svg" alt />
